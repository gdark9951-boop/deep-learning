...
const SAMPLE_CSV =
    ...
    `2026-02-19 10:00:01,192.168.1.12,10.0.0.5,51235,443,TCP,15,4096,400,1,1,0,0,benign\n` +
    `2026-02-19 10:00:02,192.168.1.18,10.0.0.5,51236,443,TCP,5,800,150,1,1,0,0,benign\n` +
    `2026-02-19 10:00:02,192.168.1.22,10.0.0.5,51237,80,TCP,12,3000,320,1,1,0,0,benign\n` +
    `2026-02-19 10:00:03,192.168.1.9,10.0.0.5,51238,443,TCP,9,1500,250,1,1,0,0,benign\n` +
    // Suddenly, a DDoS attack starts (Massive packets, short duration)
    `2026-02-19 10:00:04,203.0.113.5,10.0.0.5,13421,80,TCP,4500,450000,10,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:04,203.0.113.6,10.0.0.5,23412,80,TCP,4600,460000,11,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:04,203.0.113.7,10.0.0.5,33413,80,TCP,4700,470000,12,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:04,203.0.113.8,10.0.0.5,43414,80,TCP,4800,480000,10,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:04,203.0.113.9,10.0.0.5,53415,80,TCP,4900,490000,11,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:05,203.0.113.10,10.0.0.5,14416,80,TCP,5000,500000,10,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:05,203.0.113.11,10.0.0.5,24417,80,TCP,5100,510000,12,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:05,203.0.113.12,10.0.0.5,34418,80,TCP,5200,520000,11,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:05,203.0.113.13,10.0.0.5,44419,80,TCP,5300,530000,10,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:05,203.0.113.14,10.0.0.5,54420,80,TCP,5400,540000,11,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:06,203.0.113.15,10.0.0.5,15421,80,TCP,5500,550000,9,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:06,203.0.113.16,10.0.0.5,25422,80,TCP,5600,560000,8,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:06,203.0.113.17,10.0.0.5,35423,80,TCP,5700,570000,10,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:06,203.0.113.18,10.0.0.5,45424,80,TCP,5800,580000,11,1,0,0,0,ddos\n` +
    `2026-02-19 10:00:06,203.0.113.19,10.0.0.5,55425,80,TCP,5900,590000,12,1,0,0,0,ddos\n` +
    // Port Scanning mixed in (Stealthy)
    `2026-02-19 10:00:07,172.16.5.9,10.0.0.5,45321,22,TCP,1,40,5,1,0,0,1,portscan\n` +
    `2026-02-19 10:00:07,172.16.5.9,10.0.0.5,45321,23,TCP,1,40,5,1,0,0,1,portscan\n` +
    `2026-02-19 10:00:07,172.16.5.9,10.0.0.5,45321,3389,TCP,1,40,6,1,0,0,1,portscan\n` +
    `2026-02-19 10:00:07,172.16.5.9,10.0.0.5,45321,8080,TCP,1,40,5,1,0,0,1,portscan\n` +
    `2026-02-19 10:00:07,172.16.5.9,10.0.0.5,45321,53,TCP,1,40,4,1,0,0,1,portscan\n` +
    // More Normal Traffic struggling to connect
    `2026-02-19 10:00:08,192.168.1.10,10.0.0.5,51239,443,TCP,2,150,5000,1,0,0,0,benign\n` +
    `2026-02-19 10:00:09,192.168.1.12,10.0.0.5,51240,443,TCP,2,150,5500,1,0,0,0,benign\n` +
    // Brute Force attack on SSH
    `2026-02-19 10:00:10,10.0.0.99,10.0.0.5,33001,22,TCP,20,2500,4000,1,1,0,0,bruteforce\n` +
    `2026-02-19 10:00:11,10.0.0.99,10.0.0.5,33002,22,TCP,22,2700,4200,1,1,0,0,bruteforce\n` +
    `2026-02-19 10:00:12,10.0.0.99,10.0.0.5,33003,22,TCP,18,2100,3800,1,1,0,0,bruteforce\n` +
    `2026-02-19 10:00:13,10.0.0.99,10.0.0.5,33004,22,TCP,25,3100,5000,1,1,0,0,bruteforce\n` +
